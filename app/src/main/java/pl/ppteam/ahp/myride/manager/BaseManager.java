    ...
    ArrayList<Ride> rideDB = new ArrayList<Ride>() {{
        try {
            add(new Ride(1, MeansOfTransport.BUS, city1, city2, 34.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 12:25"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 15:25"), 180));

            add(new Ride(2, MeansOfTransport.TRAIN, city1, city2, 27.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 23:10"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 3:20"), 250));

            add(new Ride(3, MeansOfTransport.PLANE, city1, city2, 60.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 19:10"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 20:00"), 50));

            add(new Ride(4, MeansOfTransport.CAR, city1, city2, 35.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 18:30"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 21:00"), 150));

            add(new Ride(5, MeansOfTransport.CAR, city1, city2, 42.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 7:30"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 11:00"), 210));

            add(new Ride(7, MeansOfTransport.BUS, city1, city2, 35.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 15:30"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 19:00"), 210));

            add(new Ride(8, MeansOfTransport.TRAIN, city1, city2, 37.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 22:00"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-21 1:30"), 210));
            ...
            add(new Ride(17, MeansOfTransport.TRAIN, city4, city5, 27.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 23:10"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 3:20"), 250));
            ...
            add(new Ride(23, MeansOfTransport.BUS, city3, city5, 34.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 12:25"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-19 15:25"), 180));
            ...
            add(new Ride(28, MeansOfTransport.BUS, city6, city4, 32.0, true,
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 15:30"),
                    new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2015-06-20 19:00"), 210));
